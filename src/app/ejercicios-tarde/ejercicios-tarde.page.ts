...
@Component({
  selector: 'app-ejercicios-tarde',
  templateUrl: './ejercicios-tarde.page.html',
  styleUrls: ['./ejercicios-tarde.page.scss'],
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
...
export class EjerciciosTardePage implements OnInit {
  constructor() {}
