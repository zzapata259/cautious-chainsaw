...
@Component({
  selector: 'app-ejercicios-noche',
  templateUrl: './ejercicios-noche.page.html',
  styleUrls: ['./ejercicios-noche.page.scss'],
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
...
export class EjerciciosNochePage implements OnInit {
  constructor() {}
